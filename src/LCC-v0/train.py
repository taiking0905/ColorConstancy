...
from config import HISTPRE_DIR,REAL_RGB_JSON_PATH,EPOCHS, OUTPUT_DIR, BATCH_SIZE, LEARNING_RATE, DEVICE, set_seed
...
def main():
    ...
    # 1. データ読み込み
    X_train_df, y_train_df = load_dataset(HISTPRE_DIR, REAL_RGB_JSON_PATH)
    X_val_df, y_val_df = load_dataset(HISTPRE_DIR, REAL_RGB_JSON_PATH)
